...
{
	elm.i = 0;
	while (elm.i < n_lines - 1)
	{
		elm.j = skip_spaces(map[elm.i]);
		if ((map[elm.i][elm.j] == 'N' && map[elm.i][elm.j + 1] == 'O'
			&& map[elm.i][elm.j + 2] == ' '))
			elm.i++;
		else if ((map[elm.i][elm.j] == 'S' && map[elm.i][elm.j + 1] == 'O'
			&& map[elm.i][elm.j + 2] == ' '))
			elm.i++;
		else if ((map[elm.i][elm.j] == 'W' && map[elm.i][elm.j + 1] == 'E'
			&& map[elm.i][elm.j + 2] == ' '))
			elm.i++;
		else if ((map[elm.i][elm.j] == 'E' && map[elm.i][elm.j + 1] == 'A'
			&& map[elm.i][elm.j + 2] == ' '))
			elm.i++;
		else if ((map[elm.i][elm.j] == 'F' && map[elm.i][elm.j + 1] == ' '))
			elm.i++;
		else if ((map[elm.i][elm.j] == 'C' && map[elm.i][elm.j + 1] == ' '))
			elm.i++;
